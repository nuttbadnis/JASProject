<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ShowPayin_chk_CQ.aspx.vb" Inherits="ShowPayin_chk_CQ" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Show Report ค้างนำฝากเช็คแบบตรวจสอบ</title>
    <style type="text/css">
        body
        {
	        background: white;
...
<body>
    ...
    <div>       
        ...
        <table width="100%">
            ...
            <tr>
                <td>
                    ...
                    <asp:Label ID="LblGv1" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="ActiveCaption"
                        Text="รายงานเช็คค้างนำฝากแบบตรวจสอบ" Width="376px"></asp:Label></td>
            ...
            <tr>
                <td align="center">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ForeColor="Black" AlternatingRowStyle-BackColor="#DAF8FC" Width="70%" >
                        <HeaderStyle CssClass="HeaderStyle"/>
                        <Columns>
                          <asp:BoundField DataField="CompanyReceipt" HeaderText="บริษัท" />
                            <asp:BoundField DataField="f03" HeaderText="เขตธุรกิจ" />
                            <asp:BoundField DataField="f06" HeaderText="จังหวัด" />
                            <asp:BoundField DataField="CodeShop" HeaderText="สำนักงาน" />
                                  <asp:BoundField DataField="ReceiptDate" HeaderText="วันที่รับชำระ" />
                             <asp:BoundField DataField="ChequeNo" HeaderText="เลขที่เช็ค" />
                            <asp:BoundField DataField="Amount" HeaderText="จำนวนเช็คคงเหลือยังไม่นำฝาก" />  
            ...
            <tr>
                <td align="center" style="width: 757px; height: 49px;">
                    <asp:Label ID="LblNo1" runat="server" Font-Bold="True" Text="** ไม่พบข้อมูลที่ค้นหา **" Visible="False" ForeColor="Red"></asp:Label><br />
                    <br />
                    <asp:Label ID="remark1" runat="server" Font-Bold="True" Text="   *** ข้อมูลค้างนำฝากสะสมตั้งแต่วันที่ 01/11/2009 ***"></asp:Label></td>
            </tr>            
        </table>
