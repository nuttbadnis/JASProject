<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ShowPayin_Sum_CQ.aspx.vb" Inherits="ShowPayin_Sum_CQ" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Show Report ค้างนำฝากเช็คแบบสรุป</title>
    <style type="text/css">
        body
        {
	        background: white;
            ...
            <tr>
                <td>
                    ...
                    <asp:Label ID="LblGv1" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="ActiveCaption"
                        Text="รายงานเช็คค้างนำฝากแบบสรุป" Width="376px"></asp:Label></td>
            ...
            <tr>
                <td align="center">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ForeColor="Black" AlternatingRowStyle-BackColor="#DAF8FC" Width="70%" >
                     ...
                     <%--       <asp:BoundField DataField="receipt_cq" HeaderText="จำนวนเช็คที่รับเข้ามา" />
                            <asp:BoundField DataField="payin_cq" HeaderText="จำนวนเช็คที่ฝาก" />--%>
