<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ShowPayin_sum_CS.aspx.vb" Inherits="ShowPayin_sum_CS" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Show Report ค้างนำฝากเงินสดแบบสรุป</title>
    <style type="text/css">
        body
        {
	        background: white;
            ...
            <tr>
                <td>
                    ...
                    <asp:Label ID="LblGv1" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="ActiveCaption"
                        Text="รายงานเงินสดค้างนำฝากแบบสรุป" Width="376px"></asp:Label></td>
                ...
                <td align="center">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ForeColor="Black" AlternatingRowStyle-BackColor="#DAF8FC" Width="70%" >
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="receipt_cs" HeaderText="จำนวนเงินสดที่รับ"/>
                            <asp:BoundField DataField="payin_cs" HeaderText="จำนวนเงินสดที่ฝาก" />
