...
Partial Class ShowPayin_sum_CS
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Session("StringQuery2") IsNot Nothing Then
            ShowGrid()
            'SetColumnWidth()
            ShowHeader()
        Else
    ...
    Private Sub ShowGrid()
        Try
            ...
            Dim strSql As String = Session("StringQuery2")
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim cs_in_sys As Double = e.Row.Cells(6).Text
            ...
            cs_in_sys = String.Format(e.Row.Cells(6).Text, "{0:00,00.00}")
            e.Row.Cells(6).Text = Format(cs_in_sys, "#,##0.00")
